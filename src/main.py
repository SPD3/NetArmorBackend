...
from src.website_owner_endpoints import add_scan_result, get_scan_results, get_website_owner_info
...
def register_endpoints(app:App):
    ...
    app.register_endpoint("get_website_owner_info", get_website_owner_info, Endpoint.GET)
