...
from tests.constants import XSS_NAME, XSS_DATE_ADDED, MINNIE_SCAN_ID, MINNIE_EMAIL, MINNIE_URL, SQLI_NAME, MICKEY_SCAN_ID, MICKEY_EMAIL, MICKEY_URL, SQLI_DATE, SQLI_DESCRIPTION, XSS_DESCRIPTION, MICKEY_SCAN_SCORE, MINNIE_SCAN_SCORE, SQLI_SUCCESS, XSS_SUCCESS
...
def test_add_tested_vulnerability():
    ...
    generic_add_test(lambda: check_tested_vulnerability(db_session, MICKEY_SCAN_ID, SQLI_NAME, MICKEY_SCAN_SCORE, SQLI_SUCCESS, SQLI_DESCRIPTION),
                     ...
                     lambda: check_tested_vulnerability(db_session, MINNIE_SCAN_ID, XSS_NAME, MINNIE_SCAN_SCORE, XSS_SUCCESS, XSS_DESCRIPTION),
                     lambda: add_mock_tested_vulnerability(db_session, MINNIE_SCAN_ID, XSS_NAME, MINNIE_SCAN_SCORE, XSS_SUCCESS, XSS_DESCRIPTION, MINNIE_EMAIL, MINNIE_URL))
    db_session.rollback()
