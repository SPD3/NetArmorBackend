...
from tests.constants import XSS_NAME, XSS_DATE_ADDED, MINNIE_EMAIL, MINNIE_URL, SQLI_NAME, MICKEY_EMAIL, MICKEY_URL, SQLI_DATE_ADDED, SQLI_DESCRIPTION, XSS_DESCRIPTION, MICKEY_SCAN_SCORE, MINNIE_SCAN_SCORE, SQLI_SUCCESS, XSS_SUCCESS
...
def test_add_vulnerability_table():
    ...
    generic_add_test(lambda: check_vulnerability(db_session,SQLI_NAME, SQLI_DATE_ADDED),
                     lambda: add_vulnerability(db_session, SQLI_NAME, SQLI_DATE_ADDED), 
...
def test_duplicate_vulnerability_table():
    ...
    generic_duplicate_test(db_session, 
                           lambda: add_vulnerability(db_session, SQLI_NAME, SQLI_DATE_ADDED),
                           lambda: add_vulnerability(db_session, SQLI_NAME, SQLI_DATE_ADDED-timedelta(days=1)))
    db_session.rollback()
