...
from tests.constants import CSRF_LINK, CSRF_TITLE, CSRF_NAME, MINNIE_EMAIL, CSRF_RATING, SQLI_LINK, MICKEY_EMAIL, SQLI_NAME, SQLI_TITLE, SQLI_RATING
...
def test_add_resource_table():
    ...
    generic_add_test(lambda: check_resource(db_session, SQLI_LINK, SQLI_TITLE, SQLI_NAME), 
                     ...
                     lambda: add_mock_resource(db_session, CSRF_LINK, CSRF_TITLE, CSRF_NAME))
    db_session.rollback()
...
def test_add_resource_rating():
    ...
    generic_add_test(lambda: check_resource_rating(db_session, MICKEY_EMAIL, SQLI_LINK, SQLI_RATING), 
                     ...
                     lambda: add_mock_resource_rating(db_session, MINNIE_EMAIL, CSRF_LINK, CSRF_RATING, CSRF_NAME))
    db_session.rollback()
