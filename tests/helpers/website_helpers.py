...
def add_mock_cookie(db_session, cookie_value, email, password=MICKEY_PASSWORD, first_name=MICKEY_FIRST_NAME, last_name=MICKEY_LAST_NAME, image=MICKEY_IMAGE):
    add_website_owner(db_session, email, password, first_name, last_name, image)
    add_cookie(db_session, cookie_value, email)
