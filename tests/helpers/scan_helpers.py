...
def add_mock_scan(db_session, scan_id, email, url, score, deep, date_added, website_name=MICKEY_WEBSITE_NAME, password=MICKEY_PASSWORD, first_name=MICKEY_FIRST_NAME, last_name=MICKEY_LAST_NAME, image=MICKEY_IMAGE):
    add_mock_website(db_session, url, email, website_name, password, first_name, last_name, image)
    add_scan(db_session, scan_id, email, url, score, deep, date_added)